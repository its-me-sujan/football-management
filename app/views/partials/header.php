...
$pageTitle = $pageTitle ?? 'Football Management';
...
<nav class="navbar navbar-expand-lg custom-navbar sticky-top">
    <div class="container">
        <a class="navbar-brand" href="<?= e(app_url('/index.php')) ?>">Football Management</a>
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            ...
            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
                <?php if (is_logged_in()): ?>
                    ...
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link nav-link-cta" href="<?= e(app_url('/auth/logout.php')) ?>">Logout</a>
                    </li>
                <?php else: ?>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-cta" href="<?= e(app_url('/auth/register.php')) ?>">Register</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
